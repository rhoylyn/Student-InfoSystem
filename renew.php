...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `subjects` SET `subject_code`='$subject_code', `subject_units`='$subject_units', `subject_description`='$subject_description' WHERE `id`=$id";
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="subject_description" value="<?php echo $row['subject_description']; ?>">
        </div>
        
        <div class="mb-3">
          <label class="form-label">Subject Units</label>
          <input type="text" class="form-control" name="subject_units" value="<?php echo $row['subject_units']; ?>">
        </div>
        <div>
